...
\begin{scriptsize}
$\mf{y} = \mf{Ax}$, where $\mf{A} = \mf{U}\mf{\Sigma}\mf{V}^T$, $\mf{A} \in \mb{R}^{n \times n}$ and $rank\lp\mf{A}\rp = n$. \vspace{0.2cm}

$1 = \lV\mf{x}\rV^2 = \lV\mf{A}^{-1}\mf{y}\rV^2$\vspace{0.1cm}

$ = \mf{y}^T\mf{A}^{-T}\mf{A}^{-1}\mf{y}$\vspace{0.1cm}

$ = \mf{y}^T\lp\mf{V}\mf{\Sigma}^{-1}\mf{U}^T\rp^T\mf{V}\mf{\Sigma}^{-1}\mf{U}^T\mf{y}$\vspace{0.1cm}

$ = \mf{y}^T\mf{U}\mf{\Sigma}^{-1}\mf{V}^T\mf{V}\mf{\Sigma}^{-1}\mf{U}^T\mf{y}$\vspace{0.1cm}

$ = \mf{w}^T\mf{\Sigma}^{-2}\mf{w}$\vspace{0.1cm}

where, $\mf{w} = \mf{U}^T\mf{y}$; %and $\mf{\Sigma}^{-2} = \bmxc \mf{D}^{-2} & \mf{0}\\\mf{0} & \mf{0}\emx$.
...
\begin{center}
    ...
    \draw[gray, -latex, line width=0.1mm] (-2, 0) -- (2, 0) node[below] {$\mf{x}_1$};
    \draw[gray, -latex, line width=0.1mm] (0, -1.5) -- (0, 1.5) node[above] {$\mf{x}_2$};
    ...
    \draw[gray, -latex, line width=0.1mm] (5, 0) -- (9, 0) node[below] {$\mf{x}_1$};
    \draw[gray, -latex, line width=0.1mm] (7, -1.5) -- (7, 1.5) node[above] {$\mf{x}_2$};
    \draw[thick] (7,0) circle (1);
    \draw[blue, -latex, line width=0.2mm] (7, 0) -- (7 + 1, 0) node[right, yshift=0.35cm] {$\mf{V}^T\mf{v}_1$};
    \draw[blue, -latex, line width=0.2mm] (7, 0) -- (7, 1) node[left, yshift=0.25cm] {$\mf{V}^T\mf{v}_2$};
    \draw[red, -latex, line width=0.2mm] (7, 0) -- (7+0.5736, 0.8192) node[right, yshift=0.25cm] {$\mf{V}^T\mf{x}$};


    \draw[black, ->, line width=0.8mm] (7, -1.7) -- (7, -2.8);

    \draw[gray, -latex, line width=0.1mm] (5, -5) -- (9, -5) node[below] {$\mf{x}_1$};
    \draw[gray, -latex, line width=0.1mm] (7, -7) -- (7, -3) node[right] {$\mf{x}_2$};
    \draw[thick] (7,-5) ellipse (1.414 and 0.707);
    \draw[blue, -latex, line width=0.2mm] (7, -5) -- (7 + 1.414, -5) node[right, yshift=0.35cm] {$\sigma_1\mf{V}^T\mf{v}_1$};
    \draw[blue, -latex, line width=0.2mm] (7, -5) -- (7, -5 + 0.707) node[left, yshift=0.25cm] {$\sigma_2\mf{V}^T\mf{v}_2$};
    \draw[red, -latex, line width=0.2mm] (7, -5) -- (7 + 0.8115, -5 + 0.5791) node[xshift=0.2cm, yshift=0.3cm] {$\mf{\Sigma}\mf{V}^T\mf{x}$};


    \draw[black, ->, line width=0.8mm] (4.5, -5) -- (2.5, -5);

    \draw[gray, -latex, line width=0.1mm] (-2, -5) -- (2, -5) node[below] {$\mf{x}_1$};
    \draw[gray, -latex, line width=0.1mm] (0, -7) -- (0, -3) node[right] {$\mf{x}_2$};
    \draw[thick, rotate around={60:(0,-5)}] (0,-5) ellipse (0.707 and 1.414);
    \draw[blue, -latex, line width=0.2mm] (0, -5) -- (1.225, -5 - 0.707) node[right, yshift=-0.2cm] {$\mf{U}\sigma_1\mf{V}^T\mf{u}_1$};
    \draw[blue, -latex, line width=0.2mm] (0, -5) -- (0.3535, -5 + 0.612) node[xshift=0.6cm, yshift=0.35cm] {$\mf{U}\sigma_2\mf{V}^T\mf{u}_2$};
    \draw[red, -latex, rotate around={-30:(0,-5)}, line width=0.2mm] (0, -5) -- (0 + 0.8115, -5 + 0.5791) node[xshift=0.6cm, yshift=0.3cm] {$\mf{U}\mf{\Sigma}\mf{V}^T\mf{x}$};
    \end{tikzpicture}
\end{center}
\end{column}
\end{columns}
