...
\begin{column}{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=1.7, tdplot_main_coords, axis/.style={-stealth,gray,thin}, vector/.style={-stealth, black, thick}, vector hat/.style={-stealth,gray,thick}, vector proj/.style={-stealth,violet,ultra thin}]
...
\begin{axis}[
    xmode=log,
    ymode=linear,
    xlabel=$\rho$, % \hertz requires SIunits
    ylabel=$\hat{\mathbf{x}}$,
    title={\Large{Least squares approximate solution $\hat{\mathbf{x}}\left(\rho\right)$}},
    grid=both,
    minor grid style={gray!0},
    major grid style={gray!0},
    width=1.5\linewidth,
    no marks]
\addplot[line width=1pt,solid,color=blue] %
    table[x=l,y=x1,col sep=comma]{multiobj.csv};
\addlegendentry{$\hat{x}_1$};
\addplot[line width=1pt,solid,color=red] %
    table[x=l,y=x2,col sep=comma]{multiobj.csv};
\addlegendentry{$\hat{x}_2$};
\addplot[line width=1pt,solid,color=green] %
    table[x=l,y=x3,col sep=comma]{../../temp/data/multiobj_all.csv};
...
\begin{axis}[
    xmode=linear,
    ymode=linear,
    xlabel=$J_1\left(\rho\right)$, % \hertz requires SIunits
    ylabel=$J_2\left(\rho\right)$,
    title={\Large{Optimal trade-off curve}},
    grid=both,
    minor grid style={gray!0},
    major grid style={gray!0},
    width=1.5\linewidth,
    no marks]
\addplot[line width=1pt,solid,color=blue] %
    table[x=J1,y=J2,col sep=comma]{../../temp/data/multiobj_all.csv};
\addplot[only marks,color=red] %
    table[x=J1,y=J2,col sep=comma]{../../temp/data/multiobj_sel.csv};
\node at (180, 180) [right]{$\rho=1.0$};
\node at (20, 580) [right]{$\rho=0.1$};
\node at (480, 70) [right]{$\rho=10.$};
\end{axis}
\end{tikzpicture}
\end{center}
\end{column}
